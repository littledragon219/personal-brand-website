                ...
                <ScrollReveal delay={400}>
                  <Card className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300">
                    ...
                    <CardContent className="space-y-6">
                      {[
                        { icon: Mail, title: "邮箱", content: "contact@example.com", colorClasses: "from-blue-500/20 to-cyan-500/20" },
                        { icon: MessageCircle, title: "微信", content: "请邮件联系获取", colorClasses: "from-green-500/20 to-emerald-500/20" },
