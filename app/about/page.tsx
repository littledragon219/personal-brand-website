...
const journeyItems = [
  {
    ...
    description: "作为部长/学生教练/龙珠，我带领团队坚持每周，三天早上6点30分训练，将传统文化与现代体育竞技精神结合。在全国大学生参赛队伍中脱颖而出，勇夺季军。这体现了理论与实践、身体与心智结合的\"具身\"精神。",
...
const philosophyItems = [
  ...
  },
  {
    icon: "⚡",
    title: "技术与商业结合",
    description: "技术应该服务于实际需求，每一个功能都应该有明确的用户价值和商业意义。",
    colorClasses: "from-green-500/20 to-emerald-500/20"
  },
  {
    icon: "🌉",
